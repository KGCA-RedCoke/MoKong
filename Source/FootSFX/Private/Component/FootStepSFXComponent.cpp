...
void UFootStepSFXComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UFootStepSFXComponent::FootStep()
{
...
void UFootStepSFXComponent::SetAnimation(UAnimSequenceBase* NewAnimation)
{
	Animation = NewAnimation;
}

void UFootStepSFXComponent::GetRefData()
{
...
void UFootStepSFXComponent::SpawnFootStepParticle()
{
	// Left
	FootLineTrace(LeftFootStepSocket);

	ParticleName = PhysicalMaterial ? *PhysicalMaterial->GetName() : FName();
	...
	if (bFootStepNiagara)
	{
		UNiagaraComponent* NiagaraComponent = UNiagaraFunctionLibrary::SpawnSystemAtLocation(
		 GetWorld(),
		 Niagara,
		 MeshComponent->GetSocketLocation(FootName),
		 Rotation,
...
void UFootStepSFXComponent::FootLineTrace(const FName& SocketName)
{
...
void UFootStepSFXComponent::OnActorHit_Event(AActor*           SelfActor, AActor* OtherActor, FVector NormalImpulse,
