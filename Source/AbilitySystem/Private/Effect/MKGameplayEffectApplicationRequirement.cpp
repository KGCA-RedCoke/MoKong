...
#include "Effect/MKGameplayEffectApplicationRequirement.h"

#include "GameplayEffect.h"

UMKGameplayEffectApplicationRequirement::UMKGameplayEffectApplicationRequirement()
{
...
bool UMKGameplayEffectApplicationRequirement::CanGameplayEffectApply(
...
#if WITH_EDITOR
EDataValidationResult UMKGameplayEffectApplicationRequirement::IsDataValid(
...
bool UMKGameplayEffectApplicationRequirement::K0_CanApplyGameplayEffect_Implementation(
