...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FMKPlayMontageAndWaitForEventDelegate,
											 FGameplayTag,
											 EventTag,
											 FGameplayEventData,
											 EventData);
 ...
 */
UCLASS()
class ABILITYSYSTEM_API UAbilityTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	FMKPlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FMKPlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FMKPlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FMKPlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FMKPlayMontageAndWaitForEventDelegate EventReceived;
