...
#include "EffectWidgetController.generated.h"
...
class ABILITYSYSTEM_API UEffectWidgetController : public UMVVMViewModelBase
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(BlueprintReadOnly)
	TObjectPtr<const UMKGameplayEffectUIData> EffectUIData;
...
public:
	...
	void InitializeController(APlayerController*          InOwningPlayer, UPanelWidget*                InPanelWidget,
							  FActiveGameplayEffectHandle Handle, const UMKGameplayEffectUIData* const InEffectUIData);
	...
	void OnStackChanged(FActiveGameplayEffectHandle ActiveGameplayEffectHandle, const int32 NewStackCount,
	...
	void OnTimeChanged(FActiveGameplayEffectHandle ActiveGameplayEffectHandle, const float NewStartTime,
